...
export default function Footer() {
    return (
        ...
        //             <img src='/lg.png' className='w-32 lg:w-50 h-auto' ></img>
        ...
        // </div>
        <footer className="bg-white px-5 lg:px-40 dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        ...
                        <h2 className="my-6 text-2xl  bg-clip-text  text-transparent bg-gradient-to-r from-lime-500 to-salmon-500 font-semibold">
                           Paradise
                        </h2>
                    </div>
